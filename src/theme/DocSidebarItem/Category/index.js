...
import { FolderIcon } from '@site/src/components/IcesiIcons';
...
function CategoryLinkLabel({label}) {
  ...
  return (
    <span className={clsx(styles.categoryLinkLabel, 'icesiSidebarItemWrapper')}>
      <FolderIcon className="icesiSidebarIcon" size={16} />
