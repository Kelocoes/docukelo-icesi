...
<BrowserWindow minHeight={240}>
  <>
    <p className="responsive-bg">Redimensiona la ventana del navegador. Cuando el ancho de este documento sea de 600 píxeles o menos, el color de fondo será "lightblue", de lo contrario será "lightgreen".</p>
    <style>
      {`
        .responsive-bg {
          background-color: lightgreen;
